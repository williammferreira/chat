...
class AppGroup(models.Model):
    ...
    importance = models.PositiveIntegerField(
        verbose_name=_('importance'), default=4)
...
class App(models.Model):
    ...
    # Cost per year
    cost_yearly = models.DecimalField(
        max_digits=5, decimal_places=2, default=0, verbose_name=_("cost yearly"))
    cost_monthely = models.DecimalField(
        max_digits=5, decimal_places=2, default=0, verbose_name=_("cost monthely"))
    group = models.ForeignKey(AppGroup, on_delete=models.CASCADE,
                              blank=True, null=True, default=None, verbose_name=_('group'))
